<div class="row my-5">
    ...
    <div class="col-md-12">
        <form class="form-inline" method="get" action="/reports-filter-operator">
            ...
            @endforeach
            @if(Route::is('reports-filter-operator'))
                <a class="btn btn-outline-info mr-4" href="/operatorreports">Очистить</a>
            @endif
